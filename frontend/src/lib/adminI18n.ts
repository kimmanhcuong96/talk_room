...
const copies: Record<Language, Record<AdminTranslationKey, string>> = {
  en: {
    ...
    userRoleSupporter: "Supporter", userRoleUnverified: "Unverified", userRoleVerified: "Verified", users: "Users"
  },
  vi: {
    ...
    userRoleSupporter: "Supporter", userRoleUnverified: "Chưa xác minh", userRoleVerified: "Đã xác minh", users: "Người dùng"
  },
  zh: {
    ...
    userRoleUnverified: "未验证", userRoleVerified: "已验证", users: "用户"
  },
  ja: {
    ...
    userRoleUnverified: "未認証", userRoleVerified: "認証済み", users: "ユーザー"
  }
};
