...
const translations: Record<Language, Record<TranslationKey, string>> = {
  en: {
    ...
    verificationRequestRequired: "Enter at least 20 characters and accept the commitment.",
  ...
  vi: {
    ...
    verificationRequestRequired: "Hãy nhập ít nhất 20 ký tự và xác nhận cam kết.",
  ...
  zh: {
    ...
    verificationRequestRequired: "请输入至少20个字符并确认承诺。",
  ...
  ja: {
    ...
    verificationRequestRequired: "20文字以上入力し、同意してください。",
