...
export type TranslationKey =
  ...
  | "videoOn"
  | "videoUnavailable"
  | "verificationRequestTitle" | "verificationRequestIntro" | "verificationRequestMessage" | "verificationRequestMessagePlaceholder"
  | "verificationRequestCommitment" | "verificationRequestSubmit" | "verificationRequestSubmitting" | "verificationRequestPending"
  | "verificationRequestApproved" | "verificationRequestRejected" | "verificationRequestRequired" | "verificationRequestFailed"
  | "verificationRequestLoadFailed" | "verificationRequestLogin" | "requestVerification" | "closeDialog";
...
const translations: Record<Language, Record<TranslationKey, string>> = {
  en: {
    ...
    createRoomVerifiedOnly: "Any signed-in user can create a room. Only Verified and Supporter users can set a room name.",
    ...
    verificationRequestIntro: "If you commit to helping build and grow our community, send a request for review.",
    verificationRequestMessage: "Message for reviewers",
    verificationRequestMessagePlaceholder: "Tell us how you will contribute to the community...",
    verificationRequestCommitment: "I commit to helping build a respectful, supportive community.",
    verificationRequestSubmit: "Submit request",
    verificationRequestSubmitting: "Submitting...",
    verificationRequestPending: "Request pending review",
    verificationRequestApproved: "Request approved",
    verificationRequestRejected: "Request needs revision",
    verificationRequestRequired: "Enter a message and accept the commitment.",
    verificationRequestFailed: "Could not submit the request.",
    verificationRequestLoadFailed: "Could not load your request.",
    verificationRequestLogin: "Please sign in before requesting verification.",
    closeDialog: "Close dialog", requestVerification: "Request verification",
  ...
  vi: {
    ...
    createRoomVerifiedOnly: "Mọi tài khoản đã đăng nhập đều có thể tạo phòng. Chỉ Verified và Supporter mới có thể đặt tên phòng.",
    ...
    verificationRequestTitle: "Đăng ký xác minh",
    verificationRequestIntro: "Nếu bạn cam kết đồng hành xây dựng và phát triển cộng đồng, hãy gửi yêu cầu để chúng tôi xem xét.",
    verificationRequestMessage: "Lời nhắn để duyệt",
    verificationRequestMessagePlaceholder: "Hãy chia sẻ cách bạn sẽ đóng góp cho cộng đồng...",
    verificationRequestCommitment: "Tôi cam kết cùng xây dựng một cộng đồng tôn trọng và hỗ trợ lẫn nhau.",
    verificationRequestSubmit: "Gửi yêu cầu",
    verificationRequestSubmitting: "Đang gửi...",
    verificationRequestPending: "Yêu cầu đang chờ duyệt",
    verificationRequestApproved: "Yêu cầu đã được duyệt",
    verificationRequestRejected: "Yêu cầu cần được bổ sung",
    verificationRequestRequired: "Hãy nhập nội dung và xác nhận cam kết.",
    verificationRequestFailed: "Không thể gửi yêu cầu.",
    verificationRequestLoadFailed: "Không thể tải yêu cầu của bạn.",
    verificationRequestLogin: "Vui lòng đăng nhập trước khi đăng ký xác minh.",
    closeDialog: "Đóng hộp thoại", requestVerification: "Đăng ký xác minh",
  ...
  zh: {
    ...
    createRoomVerifiedOnly: "所有已登录用户都可以创建房间，只有 Verified 和 Supporter 用户可以设置房间名称。",
    ...
    roleUnverified: "未验证",
    roleVerified: "已验证",
    verificationRequestTitle: "申请认证",
    verificationRequestIntro: "如果你愿意参与建设和发展社区，请提交申请供我们审核。",
    verificationRequestMessage: "给审核人员的留言",
    verificationRequestMessagePlaceholder: "请说明你将如何为社区做出贡献……",
    verificationRequestCommitment: "我承诺共同建设一个友善、互相支持的社区。",
    verificationRequestSubmit: "提交申请",
    verificationRequestSubmitting: "提交中……",
    verificationRequestPending: "申请正在审核",
    verificationRequestApproved: "申请已通过",
    verificationRequestRejected: "申请需要补充",
    verificationRequestRequired: "请输入内容并确认承诺。",
    verificationRequestFailed: "无法提交申请。",
    verificationRequestLoadFailed: "无法加载你的申请。",
    verificationRequestLogin: "请先登录再申请认证。",
    closeDialog: "关闭对话框", requestVerification: "申请认证",
  ...
  ja: {
    ...
    createRoomVerifiedOnly: "ログイン済みのユーザーはルームを作成できます。ルーム名を設定できるのは Verified と Supporter のみです。",
    ...
    roleUnverified: "未認証",
    roleVerified: "認証済み",
    verificationRequestTitle: "認証を申請",
    verificationRequestIntro: "コミュニティの構築と発展に協力する意思がある場合は、審査のために申請してください。",
    verificationRequestMessage: "審査担当者へのメッセージ",
    verificationRequestMessagePlaceholder: "コミュニティにどう貢献するかを入力してください…",
    verificationRequestCommitment: "尊重し支え合えるコミュニティの構築に協力することを約束します。",
    verificationRequestSubmit: "申請を送信",
    verificationRequestSubmitting: "送信中…",
    verificationRequestPending: "申請を審査中",
    verificationRequestApproved: "申請が承認されました",
    verificationRequestRejected: "申請の補足が必要です",
    verificationRequestRequired: "内容を入力し、同意してください。",
    verificationRequestFailed: "申請を送信できませんでした。",
    verificationRequestLoadFailed: "申請を読み込めませんでした。",
    verificationRequestLogin: "認証を申請するには先にログインしてください。",
    closeDialog: "ダイアログを閉じる", requestVerification: "認証を申請",
...
const supportEmail = "me2talk.support@gmail.com";
...
export const infoPageCopies: Record<Language, Record<"privacy" | "contact" | "about", InfoPageCopy>> = {
  en: {
      ...
      privacy: {
        ...
        sections: [
          ...
          },
          {
            ...
            body: "Audio, video, and screen-sharing content is transmitted in real time between room participants using WebRTC. A connection may be direct or relayed through a TURN server when needed; me2talk does not intentionally record or store calls. Text messages and room information are held temporarily in memory while the service is running, may be provided to people joining that room, and are not designed as a permanent chat history."
          },
          {
          ...
          },
          {
            ...
            body: "Necessary data may be processed by Google when you sign in and by the hosting, database, or TURN infrastructure providers used by me2talk. Those providers process data under their own terms and privacy policies."
          },
          {
    ...
    contact: {
      ...
      title: "Contact Us",
      intro: "A question, an idea, or a piece of feedback can all help make me2talk better.",
      contact: {
        heading: "Email us",
    ...
    about: {
      ...
      about: {
        ...
        statementBody: "me2talk - Me to talk is built on a simple belief: an honest conversation can improve how we speak, grow our confidence, and bring us closer. No rigid lesson or complicated profile is required; choose a room, step inside, and begin with hello.",
        highlightLabel: "Your space",
        highlightBody: "Whether you come to practice a new language, share the story of your day, or meet someone on your wavelength, me2talk wants every conversation to feel easy to start and worth remembering."
      }
    }
  },
  vi: {
    privacy: {
      eyebrow: "me2talk và quyền riêng tư",
      ...
      privacy: {
        ...
        sections: [
          ...
          },
          {
            ...
            body: "Âm thanh, video và nội dung chia sẻ màn hình được truyền theo thời gian thực giữa những người trong phòng bằng WebRTC. Kết nối có thể đi trực tiếp hoặc được chuyển tiếp qua máy chủ TURN khi cần; me2talk không chủ động ghi âm hay lưu bản ghi cuộc gọi. Tin nhắn văn bản và thông tin phòng được giữ tạm trong bộ nhớ khi dịch vụ đang chạy, có thể được gửi cho người tham gia phòng đó và không được thiết kế như lịch sử trò chuyện lâu dài."
          },
          {
          ...
          },
          {
            ...
            body: "Một số dữ liệu cần thiết có thể được xử lý bởi Google khi bạn đăng nhập và bởi các nhà cung cấp hạ tầng lưu trữ, cơ sở dữ liệu hoặc kết nối TURN mà me2talk sử dụng. Các bên này xử lý dữ liệu theo điều khoản và chính sách riêng của họ."
          },
          {
    ...
    contact: {
      ...
      title: "Liên hệ",
      intro: "Một câu hỏi, một ý tưởng hay một lời góp ý đều có thể giúp me2talk trở nên tốt hơn.",
      contact: {
    ...
    about: {
      ...
      about: {
        ...
        statementBody: "me2talk - Me to talk được tạo ra với một niềm tin đơn giản: một cuộc trò chuyện chân thành có thể giúp ta phát âm tốt hơn, tự tin hơn và cũng cảm thấy gần nhau hơn. Không cần một bài học cứng nhắc hay hồ sơ cầu kỳ; hãy chọn căn phòng phù hợp, bước vào và bắt đầu bằng một lời chào.",
        highlightLabel: "Không gian của bạn",
        highlightBody: "Dù bạn đến để luyện một ngôn ngữ mới, kể câu chuyện của ngày hôm nay hay tìm một người bạn cùng tần số, me2talk luôn muốn mỗi cuộc trò chuyện đều dễ bắt đầu và đáng để nhớ."
      }
    }
  },
  zh: {
    privacy: {
      ...
      privacy: {
        ...
        sections: [
          ...
          { heading: "2. 音频、视频和消息", body: "音频、视频和屏幕共享内容会通过 WebRTC 在房间参与者之间实时传输。连接可能是直接连接，也可能在需要时通过 TURN 服务器中继；me2talk 不会主动录制或保存通话。文字消息和房间信息会在服务运行期间临时保存在内存中，可能提供给加入该房间的人，并不是长期聊天记录。" },
          { heading: "3. 我们如何使用数据", body: "我们使用数据来完成登录、在房间中显示身份、连接参与者、运行聊天和通话、维护安全、诊断错误并提升服务稳定性。我们不会出售你的个人数据。" },
          { heading: "4. 服务提供商", body: "当你登录时，Google 可能会处理必要数据；me2talk 使用的托管、数据库或 TURN 基础设施提供商也可能处理必要数据。这些提供商会按照其自身条款和隐私政策处理数据。" },
    ...
    contact: {
      eyebrow: "我们在倾听",
      title: "联系我们",
      intro: "一个问题、一个想法或一条反馈，都能帮助 me2talk 变得更好。",
      contact: {
        heading: "给我们发邮件",
    ...
    about: {
      ...
      about: {
        ...
        statementBody: "me2talk - Me to talk 建立在一个简单的信念上：真诚的对话可以帮助我们说得更好、更有自信，也让人与人更靠近。不需要僵硬的课程或复杂的资料；选择一个房间，进入其中，从一句问候开始。",
        highlightLabel: "属于你的空间",
        highlightBody: "无论你是来练习一门新语言、分享今天的故事，还是遇见同频的人，me2talk 都希望每一次对话都容易开始，也值得记住。"
      }
    }
  },
  ja: {
    privacy: {
      eyebrow: "me2talk とプライバシー",
      title: "プライバシーポリシー",
      ...
      privacy: {
        ...
        sections: [
          ...
          { heading: "2. 音声、映像、メッセージ", body: "音声、映像、画面共有の内容は WebRTC によりルーム参加者の間でリアルタイムに送信されます。接続は直接行われる場合も、必要に応じて TURN サーバー経由で中継される場合もあります。me2talk は通話を意図的に録音または保存しません。テキストメッセージとルーム情報はサービス稼働中に一時的にメモリへ保持され、そのルームへ参加する人に提供されることがありますが、恒久的なチャット履歴として設計されていません。" },
          { heading: "3. データの利用目的", body: "データは、ログイン、ルーム内での本人表示、参加者の接続、チャットと通話の運営、セキュリティ維持、エラー診断、サービス安定性の改善に利用します。個人データを販売することはありません。" },
          { heading: "4. サービス提供者", body: "ログイン時には Google が必要なデータを処理する場合があります。また、me2talk が利用するホスティング、データベース、TURN インフラ提供者も必要なデータを処理する場合があります。これらの提供者は各自の規約とプライバシーポリシーに従ってデータを処理します。" },
    ...
    about: {
      ...
      about: {
        ...
        statementBody: "me2talk - Me to talk は、誠実な会話が発音を良くし、自信を育て、人と人を近づけるというシンプルな信念から生まれました。堅いレッスンや複雑なプロフィールは必要ありません。合うルームを選び、入室し、こんにちはから始めましょう。",
        highlightLabel: "あなたのための場所",
        highlightBody: "新しい言語を練習したい日も、今日の出来事を話したい日も、同じ空気感の人に出会いたい日も、me2talk はすべての会話が始めやすく、思い出に残るものになることを願っています。"
      }
    }
  }
};
